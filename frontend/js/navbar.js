  ...
  if (user.role === "farmer") {
    nav.innerHTML = `
      <div class="d-flex align-items-center gap-2 flex-wrap">
        ...
        <a href="farmer.html" class="btn btn-outline-light btn-sm rounded-pill">Dashboard</a>
        <a href="farmer-orders.html" class="btn btn-outline-light btn-sm rounded-pill">Orders</a>
        <a href="profile.html" class="btn btn-outline-light btn-sm rounded-pill">Profile</a>
        <button class="btn btn-light btn-sm fw-semibold px-3 rounded-pill" onclick="logout()">Logout</button>
      </div>
    `;
    return;
  }
